        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">BIOFIX</h3>
                <p className="text-sm text-gray-400">Engenharia Hospitalar</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">(81) 3656-1030</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">atendimento@inoveecontabilidade.com</span>
              </div>
