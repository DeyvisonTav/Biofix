      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          <div className="text-white">
            ...
            >
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-blue-300 tracking-wide uppercase">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                ...
                <br />
                <span className="text-2xl md:text-3xl lg:text-4xl text-teal-300 font-medium">
              ...
              <div className="flex items-center space-x-8 mb-8">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-slate-300 text-sm">Certificado ANVISA</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
                  <span className="text-slate-300 text-sm">ISO 9001</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <motion.button 
                className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors shadow-lg"
              ...
              <motion.button 
                className="border-2 border-slate-300 text-slate-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-slate-300 hover:text-slate-800 transition-colors"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                Solicitar Orçamento
          ...
          >
            ...
            <div className="relative">
              <motion.div 
                className="bg-gradient-to-br from-slate-100 to-white rounded-2xl p-8 shadow-2xl"
                whileHover={{ y: -5 }}
              ...
              {/* Floating badge */}
              <motion.div 
                className="absolute -top-4 -left-4 bg-teal-600 text-white px-4 py-2 rounded-full text-sm font-semibold"
                animate={{ 
                  y: [0, -10, 0],
                }}
                transition={{ 
