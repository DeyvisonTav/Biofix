            ...
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              ...
              >
                ...
                <div className="min-w-0 flex-1 overflow-hidden">
                  ...
                  <p className="text-blue-200 text-xs sm:text-sm lg:text-base break-words">Telefone: (81) 3656-1030</p>
                  <div className="text-blue-200 text-xs lg:text-sm">
                    <div className="block">Email:</div>
                    <div className="break-all overflow-wrap-anywhere word-break-all hyphens-auto">atendimento@inoveecontabilidade.com</div>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-2 sm:p-4 lg:p-8 border border-white/20">
              ...
              <form className="space-y-3 sm:space-y-4 lg:space-y-6">
                ...
                <motion.div className="relative" whileFocus={{ scale: 1.02 }}>
                  <select className="w-full px-2 py-1.5 pr-6 sm:px-3 sm:py-2.5 sm:pr-10 lg:px-4 lg:py-3 lg:pr-12 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:border-teal-400 transition-colors appearance-none cursor-pointer backdrop-blur-sm text-sm lg:text-base">
                ...
                <motion.button
                  type="submit"
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white px-3 py-2 sm:px-6 sm:py-3 lg:px-8 lg:py-4 rounded-xl font-semibold text-sm sm:text-base lg:text-lg transition-colors shadow-lg"
